...
import { ContextApi } from 'packages/localization'
...
export const DEFAULT_META: PageMeta = {
  ...
  image: 'https://beta.shibamongo.com/hero.jpg',
}
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      //   description: 'View statistics for PulseX.',
    ...
    defaultTitleSuffix: t('ShibamonGo'),
  }
}
